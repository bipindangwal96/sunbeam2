...
.type main, %function
main: 
	@ Find max of r1 & r2 and get result in r0
	
	mov r1, #12
	mov r2, #13

	@ find using thumb instruction set
	cmp r1, r2			@ r1-r2 and set NZCV flags:		subs r7, r1, r2
	bgt r1max
r2max:
	mov r0, r2
	b maxend
...
maxend:
	...
	/*
	@ find using arm instruction set
	...
	*/
	...
	@ find using thumb2 instruction set
	cmp r1, r2
	ite gt
	movgt r3, r1
	movle r3, r2
